classdef patch < handle
    ...
    methods
        ...
        function plotSlipVectors(obj,ss,ds,scale,varargin)
            % PLOTSLIPVECTORS plots the slip vectors of the fault
            % patches
            %
            %   patch.plotSlipVectors(ss,ds,scale)
            %
            % where patch is a patch object and ss and ds are the 
            % strike-slip and dip-slip components, respectively.
