classdef triangle < handle
    ...
    methods
        ...
        function exportXYZ(o,scale,fname,field)
            ...
            % vertices
            A=[o.x(o.vertices(:,1),1),o.x(o.vertices(:,1),2),o.x(o.vertices(:,1),3)];
            B=[o.x(o.vertices(:,2),1),o.x(o.vertices(:,2),2),o.x(o.vertices(:,2),3)];
            C=[o.x(o.vertices(:,3),1),o.x(o.vertices(:,3),2),o.x(o.vertices(:,3),3)];
