function [s11,s12,s13,s22,s23,s33]=computeStressPolyhedronShearZoneMixedQuad( ...
    X1,X2,X3,vertices,triangles,e11,e12,e13,e22,e23,e33,G,nu,varargin)
% function COMPUTESTRESSPOLYHEDRONSHEARZONEGAUSS computes the
% stress field associated with deforming tetrahedral strain volume
...
%
% Options:
% 'N',integer        the number of Gauss integration points [7]
...
%
% Author: Sylvain Barbot (sbarbot@ntu.edu.sg) - July 3, 2018, Singapore.
...
for l=1:numel(X1)
    ...
    for i=1:size(triangles,1)
        ...
        % center of triangle surface
        CC=(A(:)+B(:)+C(:))/3;
        
        % radius
        r=norm(CC(:)-A(:));
        
        if sqrt((x1-CC(1)).^2+(x2-CC(2)).^2+(x3-CC(3)).^2)<optionStruct.radius*r;
            % double exponential quadrature in the near field
            u11(l)=u11(l)+doubleExponential2(@(u,v) (1-v).*IU11(u,v),optionStruct.precision,optionStruct.bound);
            u12(l)=u12(l)+doubleExponential2(@(u,v) (1-v).*IU12(u,v),optionStruct.precision,optionStruct.bound);
            u13(l)=u13(l)+doubleExponential2(@(u,v) (1-v).*IU13(u,v),optionStruct.precision,optionStruct.bound);
            
            u21(l)=u21(l)+doubleExponential2(@(u,v) (1-v).*IU21(u,v),optionStruct.precision,optionStruct.bound);
            u22(l)=u22(l)+doubleExponential2(@(u,v) (1-v).*IU22(u,v),optionStruct.precision,optionStruct.bound);
            u23(l)=u23(l)+doubleExponential2(@(u,v) (1-v).*IU23(u,v),optionStruct.precision,optionStruct.bound);
            
            u31(l)=u31(l)+doubleExponential2(@(u,v) (1-v).*IU31(u,v),optionStruct.precision,optionStruct.bound);
            u32(l)=u32(l)+doubleExponential2(@(u,v) (1-v).*IU32(u,v),optionStruct.precision,optionStruct.bound);
            u33(l)=u33(l)+doubleExponential2(@(u,v) (1-v).*IU33(u,v),optionStruct.precision,optionStruct.bound);
        else
            % Gauss-Legendre quadrature in the far field
            u11(l)=u11(l)+gaussLegendre2(@(u,v) (1-v).*IU11(u,v),optionStruct.n);
            u12(l)=u12(l)+gaussLegendre2(@(u,v) (1-v).*IU12(u,v),optionStruct.n);
            u13(l)=u13(l)+gaussLegendre2(@(u,v) (1-v).*IU13(u,v),optionStruct.n);
            
            u21(l)=u21(l)+gaussLegendre2(@(u,v) (1-v).*IU21(u,v),optionStruct.n);
            u22(l)=u22(l)+gaussLegendre2(@(u,v) (1-v).*IU22(u,v),optionStruct.n);
            u23(l)=u23(l)+gaussLegendre2(@(u,v) (1-v).*IU23(u,v),optionStruct.n);
            
            u31(l)=u31(l)+gaussLegendre2(@(u,v) (1-v).*IU31(u,v),optionStruct.n);
            u32(l)=u32(l)+gaussLegendre2(@(u,v) (1-v).*IU32(u,v),optionStruct.n);
            u33(l)=u33(l)+gaussLegendre2(@(u,v) (1-v).*IU33(u,v),optionStruct.n);
        end
    end
end
...
for i=1:size(triangles,1)
    ...
    % where to remove anelastic strain
    omega=omega.*heaviside(((A(1)+B(1)+C(1))/3-X1)*n(1)+((A(2)+B(2)+C(2))/3-X2)*n(2)+((A(3)+B(3)+C(3))/3-X3)*n(3));
end
...
s33=2*G*e33+G*lambda*div;
    ...
    function d = IU11(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G11d1(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G21d1(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G31d1(y1,y2,y3);
        end
    ...
    function d = IU12(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G11d2(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G21d2(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G31d2(y1,y2,y3);
        end
    ...
    function d = IU13(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G11d3(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G21d3(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G31d3(y1,y2,y3);
        end
    ...
    function d = IU21(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G12d1(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G22d1(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G32d1(y1,y2,y3);
        end
    ...
    function d = IU22(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G12d2(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G22d2(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G32d2(y1,y2,y3);
        end
    ...
    function d = IU23(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G12d3(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G22d3(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G32d3(y1,y2,y3);
        end
    ...
    function d = IU31(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G13d1(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G23d1(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G33d1(y1,y2,y3);
        end
    ...
    function d = IU32(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G13d2(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G23d2(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G33d2(y1,y2,y3);
        end
    ...
    function d = IU33(u,v)
        ...
        if (m11*n(1)+m12*n(2)+m13*n(3)) ~= 0
            d=d+ABC/4*(m11*n(1)+m12*n(2)+m13*n(3))*G13d3(y1,y2,y3);
        end
        if (m12*n(1)+m22*n(2)+m23*n(3)) ~= 0
            d=d+ABC/4*(m12*n(1)+m22*n(2)+m23*n(3))*G23d3(y1,y2,y3);
        end
        if (m13*n(1)+m23*n(2)+m33*n(3)) ~= 0
            d=d+ABC/4*(m13*n(1)+m23*n(2)+m33*n(3))*G33d3(y1,y2,y3);
        end
...
if ~islogical(x)
    error('MATLAB:invalidConvex','invalid convex (must be logical)');
end
p = true;
end
